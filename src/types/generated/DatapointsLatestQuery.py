...
class DatapointsLatestQueryItem:
...
class DatapointsLatestQuery:
    """List of latest queries"""
    items: List[DatapointsLatestQueryItem]

    def __init__(self, items: List[DatapointsLatestQueryItem]) -> None:
        self.items = items
