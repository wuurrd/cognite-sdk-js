...
class Node3DListItem:
    """The bounding box of the subtree with this sector as the root sector. Is null if there are
    no geometries in the subtree.
    """
    bounding_box: Node3DListBoundingBox
    ...
    def __init__(self, bounding_box: Node3DListBoundingBox, depth: int, id: int, name: str, parent_id: int, subtree_size: int, tree_index: int) -> None:
...
class Node3DList:
    items: List[Node3DListItem]

    def __init__(self, items: List[Node3DListItem]) -> None:
        self.items = items
