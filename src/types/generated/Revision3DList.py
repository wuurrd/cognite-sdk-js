...
class Revision3DListItem:
    ...
    def __init__(self, asset_mapping_count: int, camera: Optional[Revision3DListCamera], created_time: int, file_id: int, id: int, metadata: Optional[Dict[str, str]], published: bool, rotation: Optional[List[float]], status: Status, thumbnail_threed_file_id: Optional[int], thumbnail_url: Optional[str]) -> None:
...
class Revision3DList:
    items: List[Revision3DListItem]

    def __init__(self, items: List[Revision3DListItem]) -> None:
        self.items = items
