...
class DatapointsQueryPropertiesClass:
    """Specify the aggregates to return. Use default if null. If the default is a set of
    aggregates, specify an empty string to get raw data.
    """
    ...
    def __init__(self, aggregates: Optional[List[Aggregate]], end: Union[int, None, str], granularity: Optional[str], include_outside_points: Optional[bool], limit: Optional[int], start: Union[int, None, str]) -> None:
