...
class RevealRevision3DSceneThreedFile:
...
class RevealRevision3D:
    ...
    scene_threed_files: List[RevealRevision3DSceneThreedFile]

    def __init__(self, asset_mapping_count: int, camera: Optional[RevealRevision3DCamera], created_time: int, file_id: int, id: int, metadata: Optional[Dict[str, str]], published: bool, rotation: Optional[List[float]], status: Status, thumbnail_threed_file_id: Optional[int], thumbnail_url: Optional[str], scene_threed_files: List[RevealRevision3DSceneThreedFile]) -> None:
