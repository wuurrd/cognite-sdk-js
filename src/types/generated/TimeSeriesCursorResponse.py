...
class TimeSeriesCursorResponseItem:
...
class TimeSeriesCursorResponse:
    """A list of objects along with possible cursors to get the next page of result"""
    items: List[TimeSeriesCursorResponseItem]
    """The cursor to get the next page of results (if available)."""
    next_cursor: Optional[str]

    def __init__(self, items: List[TimeSeriesCursorResponseItem], next_cursor: Optional[str]) -> None:
        self.items = items
