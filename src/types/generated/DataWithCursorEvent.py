...
class DataWithCursorEvent:
    """A list of objects along with possible cursors to get the next, or previous, page of
    results
    """
    items: List[DataWithCursorEventItem]
    """Cursor to get the next page of results (if available)."""
    next_cursor: Optional[str]

    def __init__(self, items: List[DataWithCursorEventItem], next_cursor: Optional[str]) -> None:
        self.items = items
