...
class DataWithCursorGetTimeSeriesMetadataDTOItem:
...
class DataWithCursorGetTimeSeriesMetadataDTO:
    """A list of objects along with possible cursors to get the next page of result"""
    items: List[DataWithCursorGetTimeSeriesMetadataDTOItem]
    """The cursor to get the next page of results (if available)."""
    next_cursor: Optional[str]

    def __init__(self, items: List[DataWithCursorGetTimeSeriesMetadataDTOItem], next_cursor: Optional[str]) -> None:
        self.items = items
