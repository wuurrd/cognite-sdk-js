...
class RevealNode3D:
    ...
    no geometries in the subtree.
    """
    bounding_box: RevealNode3DBoundingBox
    ...
    def __init__(self, bounding_box: RevealNode3DBoundingBox, depth: int, id: int, name: str, parent_id: int, subtree_size: int, tree_index: int, sector_id: Optional[int]) -> None:
