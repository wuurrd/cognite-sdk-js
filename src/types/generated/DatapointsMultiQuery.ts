...
export interface DatapointsMultiQuery {
   ...
   */
  aggregates?: DatapointsMultiQueryAggregate[];
  /**
  ...
  items: DatapointsMultiQueryItem[];
  /**
 ...
 */
export enum DatapointsMultiQueryAggregate {
  Average = 'average',
 ...
 */
export interface DatapointsMultiQueryItem {
  /**
