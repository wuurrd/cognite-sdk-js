...
class DataGetTimeSeriesMetadataDTOItem:
...
class DataGetTimeSeriesMetadataDTO:
    """List of responses. The order matches the requests order."""
    items: List[DataGetTimeSeriesMetadataDTOItem]

    def __init__(self, items: List[DataGetTimeSeriesMetadataDTOItem]) -> None:
        self.items = items
