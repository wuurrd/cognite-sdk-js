...
class DatapointsMultiQueryItem:
...
class DatapointsMultiQuery:
    ...
    """
    include_outside_points: Optional[bool]
    items: List[DatapointsMultiQueryItem]
    """Return up to this number of datapoints."""
    limit: Optional[int]
    """Get datapoints after this time. The format is N[timeunit]-ago where
    timeunit is w,d,h,m,s. Example: '2d-ago' gets datapoints that are up to 2 days
    ...
    def __init__(self, aggregates: Optional[List[Aggregate]], end: Union[int, None, str], granularity: Optional[str], include_outside_points: Optional[bool], items: List[DatapointsMultiQueryItem], limit: Optional[int], start: Union[int, None, str]) -> None:
        self.aggregates = aggregates
        self.end = end
        self.granularity = granularity
        self.include_outside_points = include_outside_points
