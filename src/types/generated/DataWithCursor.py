...
class DataWithCursor:
    """A list of objects along with possible cursors to get the next page of results"""
    items: Optional[List[DataWithCursorItem]]
    """Cursor to get the next page of results (if available)."""
    next_cursor: Optional[str]

    def __init__(self, items: Optional[List[DataWithCursorItem]], next_cursor: Optional[str]) -> None:
        self.items = items
