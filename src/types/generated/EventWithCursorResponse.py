...
class EventWithCursorResponseItem:
...
class EventWithCursorResponse:
    """A list of objects along with possible cursors to get the next, or previous, page of
    results
    """
    items: List[EventWithCursorResponseItem]
    """Cursor to get the next page of results (if available)."""
    next_cursor: Optional[str]

    def __init__(self, items: List[EventWithCursorResponseItem], next_cursor: Optional[str]) -> None:
        self.items = items
