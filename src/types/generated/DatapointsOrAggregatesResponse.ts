...
export interface DatapointsOrAggregatesResponse {
    items: DatapointsOrAggregatesResponseItem[];
}

export interface DatapointsOrAggregatesResponseItem {
    /**
     ...
     * The list of datapoints.
     */
    datapoints: DatapointsOrAggregatesResponseDatapoint[];
    /**
...
export interface DatapointsOrAggregatesResponseDatapoint {
    /**
